        ...
        <div className="w-full flex">
                ...
                <div className="flex justify-between w-full mb-10">
                    ...
                    {Array(8).fill(0).map((_, index) => (
                        <div className="w-20 h-20" key={index}>
                            <img className="rounded-full h-14 w-14" src="https://www.invert.vn/media/uploads/uploads/2022/12/06172901-11.jpeg" />
                            <span className="text-[12px]">nguyenkhactrang</span>
                        </div>
                    ))}
                </div>
                {posts.length > 0 ? (
            ...
            <div className="w-1/3 ps-16">
                <div className="flex items-center mb-3">
                    <img className="rounded-full h-10 w-10" src="https://thuthuatnhanh.com/wp-content/uploads/2020/09/hinh-anh-anime-lanh-lung-xam-chat.jpg" />
                    <div>
                ...
                {Array(4).fill(0).map((_, index) => (
                    <div className="flex items-center mb-3" key={index}>
                        <img className="rounded-full h-10 w-10" src="https://tvmcomics.com.vn/wp-content/uploads/2019/11/anime-girl-toc-bach-kim.jpg" />
                        <div>
                            <span className="ms-3 block font-bold">ktnguyen</span>
                        </div>
                    </div>
